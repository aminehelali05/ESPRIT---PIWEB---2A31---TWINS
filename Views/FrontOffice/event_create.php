...
<head>
  ...
  <title>Suggest Event — Diversity.is</title>
    ...
    <div class="container" style="max-width: 800px; margin: 0 auto;">
      <div class="glass-card" style="padding: 40px; margin-top: 40px;">
        <div class="section-header" style="text-align: left;">
          <span class="section-tag">New Event</span>
          <h1 class="text-h1">Suggest an <span class="text-gradient">Event</span></h1>
          <p class="text-body-lg">Share an event with the community. It will be reviewed by an administrator.</p>
        </div>
        ...
        <form id="eventCreateForm" action="../../index.php?action=create_event" method="POST" class="fade-in-section">
          <div style="margin-bottom: 20px;">
            <label class="text-small" style="font-weight: 600; display: block; margin-bottom: 8px;">Event Title</label>
            <input type="text" name="title" class="glass-input" style="width: 100%; padding: 12px; border-radius: 12px;" placeholder="e.g. Modern Web Development Workshop">
          </div>

          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
            <div>
              <label class="text-small" style="font-weight: 600; display: block; margin-bottom: 8px;">Date & Time</label>
              <input type="datetime-local" name="event_date" class="glass-input" style="width: 100%; padding: 12px; border-radius: 12px;">
            </div>
            <div>
          ...
          <div style="margin-bottom: 20px;">
            ...
            <input type="text" name="location" class="glass-input" style="width: 100%; padding: 12px; border-radius: 12px;" placeholder="e.g. Remote (Zoom), or Physical Address">
          </div>

          <div style="margin-bottom: 30px;">
            <label class="text-small" style="font-weight: 600; display: block; margin-bottom: 8px;">Description</label>
            <textarea name="description" rows="5" class="glass-input" style="width: 100%; padding: 12px; border-radius: 12px;" placeholder="Details about the event, what participants will learn, etc."></textarea>
          </div>

          <div style="display: flex; gap: 15px;">
            <button type="submit" class="btn btn-primary" style="flex: 2;">Submit Event</button>
            <a href="events.php" class="btn btn-secondary" style="flex: 1; text-align: center;">Cancel</a>
          </div>
        </form>
      </div>
    </div>
