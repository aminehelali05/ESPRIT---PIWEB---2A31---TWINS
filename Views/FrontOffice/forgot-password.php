...
<head>
    ...
    <title>Forgot Password | Professional Networking</title>
...
<body class="min-h-screen overflow-x-hidden flex items-center justify-center relative py-10">
    ...
    <div class="glass-card w-full max-w-lg p-8 m-4 relative z-10 animate-fade-in" style="backdrop-filter: blur(25px); -webkit-backdrop-filter: blur(25px);">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-purple-400" style="font-family: var(--font-primary);">Forgot Password</h1>
            <p class="text-zinc-500 dark:text-gray-400 mt-2">Enter your email and we will send you a reset link</p>
        </div>

        <form method="post" action="../../index.php?action=forgot_password_request" class="space-y-6">
            <div class="space-y-2">
                ...
                <div class="relative">
                    ...
                    <input type="email" name="email" required class="auth-input" placeholder="you@example.com">
                </div>
            </div>

            <button type="submit" class="btn-primary flex items-center justify-center gap-2 shadow-[0_8px_20px_-4px_rgba(79,82,217,0.3)]">
                <i data-lucide="send" class="w-5 h-5"></i> Send Reset Link
            </button>
        </form>
