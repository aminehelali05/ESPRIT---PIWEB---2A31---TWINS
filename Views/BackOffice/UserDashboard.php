...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'delete' && !empty($_POST['id'])) {
        ...
        header('Location: UserDashboard.php?success=deleted#users');
        exit;
    }
        ...
        if ($firstName === '' || $lastName === '' || $email === '') {
            ...
            if ($action === 'update') {
                ...
                if (!$existingUser) {
                    ...
                    header('Location: UserDashboard.php?success=updated#users');
                    exit;
                }
            } else {
                if ($password === '') {
                    ...
                    header('Location: UserDashboard.php?success=created#users');
                    exit;
                }
            }
        }
...
<head>
  ...
  <meta name="description" content="Diversity.is user dashboard with real CRUD.">
  ...
  <div class="dashboard-layout">
    <aside class="sidebar" id="sidebar">
      ...
      <div class="sidebar-footer">
        <a href="../FrontOffice/home.php" class="sidebar-link"><i data-lucide="home" class="w-4 h-4"></i><span>Back to Home</span></a>
      </div>
    </aside>
    ...
    <main class="dashboard-main" id="dashboardMain">
      ...
      <div class="dashboard-content">
        <section class="dash-page active" id="overview">
          <div class="page-header">
            <div>
              ...
              <p class="page-subtitle">Unified BackOffice CRUD.</p>
            </div>
          </div>
          <div class="stats-row">
        ...
        <section class="dash-page active" id="users">
          <?php if ($success !== ''): ?><div class="module-panel" style="border:1px solid rgba(34,197,94,.35); margin-bottom:14px;"><strong><?= htmlspecialchars($success) ?></strong></div><?php endif; ?>
          <?php if ($error !== ''): ?><div class="module-panel" style="border:1px solid rgba(239,68,68,.35); margin-bottom:14px;"><strong><?= htmlspecialchars($error) ?></strong></div><?php endif; ?>
          ...
          <div class="module-rich-grid" style="grid-template-columns:1.2fr .8fr; align-items:start;">
            <article class="module-panel">
              ...
              <div class="table-wrap">
                <table class="dash-table">
                  <thead><tr><th>ID</th><th>User</th><th>Role</th><th>Status</th><th>Email</th><th style="text-align:right;">Actions</th></tr></thead>
                  <tbody>
                      ...
                      <?php foreach ($users as $user): ?>
                        <tr>
                          ...
                          <td style="text-align:right; display:flex; gap:8px; justify-content:flex-end;">
                            <a class="btn btn-secondary btn-sm" href="UserDashboard.php?edit=<?= (int) $user->getId() ?>#users">Edit</a>
                            <form method="POST" action="UserDashboard.php#users" style="margin:0;" onsubmit="return confirm('Delete this user?');">
            ...
            <article class="module-panel">
              ...
              <form method="POST" action="UserDashboard.php#users">
                ...
                <div class="form-group"><label>Role</label>
                  ...
                  <select class="form-control" name="role"><option value="user" <?= $selectedRole === 'user' ? 'selected' : '' ?>>User</option><option value="manager" <?= $selectedRole === 'manager' ? 'selected' : '' ?>>Manager</option><option value="admin" <?= $selectedRole === 'admin' ? 'selected' : '' ?>>Admin</option></select>
                </div>
                ...
                <div style="display:flex; gap:8px;">
                  ...
                  <?php if ($editingUser): ?><a href="UserDashboard.php#users" class="btn btn-secondary btn-sm">Cancel</a><?php endif; ?>
                </div>
              </form>
            </article>
          </div>
