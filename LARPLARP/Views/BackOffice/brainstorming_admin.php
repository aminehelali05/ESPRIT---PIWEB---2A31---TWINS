...
$pendingSessions = $brainstormingController->listBrainstormings('', ['status' => 'EN_ATTENTE']);
$allSessions = $brainstormingController->listBrainstormings();
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Brainstorming Management — Admin Diversity</title>
    ...
    <div class="app-container" style="display: flex; min-height: 100vh;">
        <aside class="sidebar" style="width: 260px; border-right: 1px solid rgba(255,255,255,0.1); padding: 20px;">
            <div class="brand" style="margin-bottom: 40px;">
                <h2 style="color: #8b5cf6;">VoP Admin</h2>
            </div>
            <nav class="nav-menu">
                ...
                <a href="brainstorming_admin.php" class="nav-item active" style="display: flex; align-items: center; gap: 10px; padding: 12px; background: rgba(139, 92, 246, 0.1); color: #a78bfa; text-decoration: none; border-radius: 8px;">
                    <i data-lucide="lightbulb"></i> Brainstorming
                </a>
        ...
        <main class="main-content" style="flex: 1; padding: 40px;">
            <header style="margin-bottom: 40px;">
                <h1 style="font-size: 2rem;">Brainstorming <span style="color: #a78bfa;">Validation</span></h1>
                <p style="color: #94a3b8;">Review and validate new brainstorming sessions before they go live.</p>
            </header>

            <section>
                <h2 style="margin-bottom: 20px; display: flex; align-items: center; gap: 10px;">
                    <i data-lucide="clock" style="color: #f59e0b;"></i> Pending Sessions
                </h2>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <small style="color: #94a3b8;"><?= htmlspecialchars(substr($b['description'], 0, 80)) ?>...</small>
                            </td>
                            <td>
                                <span class="status-badge status-pending">PENDING</span>
                            </td>
                            <td>
                                <a href="../../index.php?action=approve_brainstorming&id=<?= $b['id'] ?>" class="action-btn btn-approve">Approve</a>
                                <a href="../../index.php?action=refuse_brainstorming&id=<?= $b['id'] ?>" class="action-btn btn-refuse">Refuse</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                        <?php if (empty($pendingSessions)): ?>
                        <tr><td colspan="4" style="text-align: center; color: #94a3b8;">No pending sessions.</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </section>
            ...
            <section style="margin-top: 60px;">
                <h2 style="margin-bottom: 20px;">Platform Sessions History</h2>
                <table class="admin-table">
                    <thead>
                        <tr>
                            <th>ID</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="status-badge status-<?= strtolower($b['status']) == 'en_attente' ? 'pending' : (strtolower($b['status']) == 'accepte' ? 'accepted' : 'refused') ?>">
                                    <?= $b['status'] ?>
                                </span>
                            </td>
                            <td>
                                <a href="../../index.php?action=delete_brainstorming&id=<?= $b['id'] ?>" class="action-btn" style="color: #ef4444;" onclick="return confirm('Delete this session permanently?')">Delete</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
